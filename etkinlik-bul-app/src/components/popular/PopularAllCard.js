...
function PopularAllCard({ name, profile_pic_url, text ,imdbRating}) {
  ...
  setNameData(name)
    ...
    return (
        <div className='filmallcard'>
          <div >
            {profile_pic_url ? (
              <img src={profile_pic_url} alt="..."  className="popularallimg"/>
            ) : (
              <img className="filmallimg"
