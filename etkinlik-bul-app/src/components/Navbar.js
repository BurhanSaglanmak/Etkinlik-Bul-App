...
function Navbar() {
  ...
  const {setSaloonDataFilter,setEtkinlikData,setTarih} =NameDataContext();
    ...
    function Kadıköy(){
        setSalon("Kadıköy Belediyesi Selamiçeşme Özgürlük Parkı Amfi Tiyatro")
    ...
    return (
        <div>
            <nav className="filter navbar navbar-expand-lg bg-light1">
                <div className="container-fluid backgroundcolornav">
                    <div className=" btn  btn-outline ">
                        <DatePicker  onChange={onChange} value={value} minDate={new Date()} maxDate={new Date(2022,5,29)}  />
                    </div>
                    <div className="collapse navbar-collapse " id="navbarNavDropdown">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <div className="dropdown">
                                    <button className="btn dropdown-toggle navbar-brand btn btn-outline-success radius" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        {etkinlik}
                                    </button>
                            ...
                            <div className="dropdown">
                                    ...
                                    <li><button onClick={CinemaximumForumİstanbul} className="dropdown-item" >Cinemaximum Forum İstanbul</button></li>
                                        ...
                                        <li><button onClick={Kadıköy} className="dropdown-item" >Kadıköy Belediyesi Selamiçeşme Özgürlük Parkı Amfi Tiyatro</button></li>
                            ...
                            <li className="nav-item">
                            <Link className="navbar-brand btn btn-outline-success radius" onClick={click} to="filter" type="submit">Filtrele</Link>
                            </li>
                        </ul>
                    </div>
                </div>
